...
public interface Provisioner extends DBusInterface{
	...
	void connect(Map<String,Variant> address);
	...
	void hb_pub_set(Map<String,Variant> info);
	 ...
	 public static class heartbeat extends DBusSignal{
		 public final Map<String,Variant>  result;
		 public heartbeat(String path,Map<String,Variant>  result) throws DBusException {
			 super(path);
			 this.result = result;
		 }
	 }
